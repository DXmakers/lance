...
exports.effectiveRpm = effectiveRpm;
exports.clientIp = clientIp;
exports.isPublicIntakeRoute = isPublicIntakeRoute;
exports.intakeRateLimit = intakeRateLimit;
exports.intakeBucketCount = intakeBucketCount;
...
function isPublicIntakeRoute(req) {
    if (req.method !== "POST")
        return false;
...
function intakeRateLimit(req, res, next) {
    ...
    const rpm = effectiveRpm();
    tracing_1.logger.warn("Public intake rate limit exceeded", {
        ip: key,
